...
just see what directories will get tested. An example output:
    ...
    % prove-rdeps perl-* -n
    prove-rdeps: [DRY] [1/8] Running prove in directory 'perl-Acme-CPANModules' ...
    prove-rdeps: [DRY] [1/8] Running prove in directory 'perl-Data-Sah' ...
    prove-rdeps: [DRY] [1/8] Running prove in directory 'perl-Data-Sah-Filter' ...
    prove-rdeps: [DRY] [1/8] Running prove in directory 'perl-Date-strftimeq' ...
    prove-rdeps: [DRY] [1/8] Running prove in directory 'perl-Log-ger' ...
    prove-rdeps: [DRY] [1/8] Running prove in directory 'perl-Log-ger-Output-Screen' ...
    prove-rdeps: [DRY] [1/8] Running prove in directory 'perl-Module-Installed-Tiny' ...
    prove-rdeps: [DRY] [1/8] Running prove in directory 'perl-Text-ANSITable' ...
    prove-rdeps: [DRY] [1/8] Running prove in directory 'perl-lib-filter' ...
